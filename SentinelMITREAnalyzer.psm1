...
<body>
    ...
    <script>
        ...
        const heatmapData = {
            'InitialAccess': { sentinel: tacticCounts['InitialAccess'] || 0, defender: defenderCounts['InitialAccess'] || 0, mde: 5, mdi: 2, mda: 0, mdo: 6, entra: 2 },
            'Execution': { sentinel: tacticCounts['Execution'] || 0, defender: defenderCounts['Execution'] || 0, mde: 15, mdi: 2, mda: 0, mdo: 2, entra: 1 },
            'Persistence': { sentinel: tacticCounts['Persistence'] || 0, defender: defenderCounts['Persistence'] || 0, mde: 18, mdi: 5, mda: 0, mdo: 2, entra: 0 },
            'PrivilegeEscalation': { sentinel: tacticCounts['PrivilegeEscalation'] || 0, defender: defenderCounts['PrivilegeEscalation'] || 0, mde: 8, mdi: 4, mda: 0, mdo: 1, entra: 1 },
            'DefenseEvasion': { sentinel: tacticCounts['DefenseEvasion'] || 0, defender: defenderCounts['DefenseEvasion'] || 0, mde: 35, mdi: 3, mda: 0, mdo: 0, entra: 2 },
            'CredentialAccess': { sentinel: tacticCounts['CredentialAccess'] || 0, defender: defenderCounts['CredentialAccess'] || 0, mde: 15, mdi: 10, mda: 0, mdo: 2, entra: 4 },
            'Discovery': { sentinel: tacticCounts['Discovery'] || 0, defender: defenderCounts['Discovery'] || 0, mde: 10, mdi: 3, mda: 0, mdo: 0, entra: 0 },
            'LateralMovement': { sentinel: tacticCounts['LateralMovement'] || 0, defender: defenderCounts['LateralMovement'] || 0, mde: 8, mdi: 4, mda: 0, mdo: 0, entra: 0 },
            'Collection': { sentinel: tacticCounts['Collection'] || 0, defender: defenderCounts['Collection'] || 0, mde: 4, mdi: 1, mda: 0, mdo: 2, entra: 3 },
            'CommandAndControl': { sentinel: tacticCounts['CommandAndControl'] || 0, defender: defenderCounts['CommandAndControl'] || 0, mde: 6, mdi: 0, mda: 0, mdo: 0, entra: 1 },
            'Exfiltration': { sentinel: tacticCounts['Exfiltration'] || 0, defender: defenderCounts['Exfiltration'] || 0, mde: 4, mdi: 0, mda: 0, mdo: 0, entra: 0 },
            'Impact': { sentinel: tacticCounts['Impact'] || 0, defender: defenderCounts['Impact'] || 0, mde: 5, mdi: 0, mda: 0, mdo: 3, entra: 0 },
            ...
            'ResourceDevelopment': { sentinel: tacticCounts['ResourceDevelopment'] || 0, defender: defenderCounts['ResourceDevelopment'] || 0, mde: 2, mdi: 0, mda: 0, mdo: 0, entra: 0 }
        };
